...
#sfdx force:package:install --package $(sfdx force:package:version:list -p 'Component Package Manager' -o CreatedDate --concise | tail -1 | awk '{print $3}') --targetusername PackageManagerTesting
